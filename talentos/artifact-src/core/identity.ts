/**
 * Conservative entity resolution (spec §12). Similar names, employers,
 * topics or locations never merge records automatically; a lookalike
 * creates an identity-review flag and a human decides.
 */
