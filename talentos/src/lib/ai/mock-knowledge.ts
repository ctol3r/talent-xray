...
const OCCUPATIONS: (MockOccupation & { match: RegExp })[] = [
  {
    key: "ml_research",
    match:
      /research (scientist|engineer)|machine learning|ml research|ai safety/i,
    ...
    channels: [
      {
        name: "Google Scholar",
        kind: "database",
        why: "Author and citation graph for the target subfields",
      },
      {
        name: "arXiv / OpenReview",
        kind: "publication",
        why: "Recent authors in the exact research areas",
      },
      {
        name: "GitHub",
        kind: "open_source",
        why: "Research engineers with runnable artifacts",
      },
      {
        name: "NeurIPS / ICML / ICLR programs",
        kind: "conference",
        why: "Speakers, authors and workshop organizers",
      },
    ],
    interviewStages: [
      "Recruiter Screen",
  ...
  },
  {
    ...
    channels: [
      {
        name: "NPI / NPPES registry",
        kind: "registry",
        why: "Authoritative directory of licensed US providers by specialty and location",
      },
      {
        name: "State medical board lookup",
        kind: "registry",
        why: "License verification and discipline history",
      },
      {
        name: "Specialty society directories",
        kind: "association",
        why: "AAFP/ACP member listings by region",
      },
      {
        name: "Residency program alumni",
        kind: "alumni",
        why: "Feeder programs within relocation distance",
      },
    ],
    interviewStages: [
      "Recruiter Screen",
      "Medical Director Interview",
      "Clinic Visit & Team Meet",
  ...
  },
  {
    ...
    adjacentTitles: [
      "Mid-Market AE ready to step up",
      "Enterprise SDR-to-AE promotions",
      "Sales Engineer moving to quota",
    ],
    domainQuestions: [
    ...
    channels: [
      {
        name: "LinkedIn Sales-community groups",
        kind: "social",
        why: "Dense, current AE population with role history",
      },
      {
        name: "RepVue",
        kind: "community",
        why: "AEs actively comparing employers",
      },
      {
        name: "Competitor org charts",
        kind: "database",
        why: "Direct-competitor AEs with transferable pipeline",
      },
      {
        name: "SaaS sales meetups (NYC)",
        kind: "event",
        why: "Local senior AE networking",
      },
    ],
    interviewStages: [
      "Recruiter Screen",
  ...
  },
  {
    ...
    channels: [
      {
        name: "NIMS credential registry",
        kind: "registry",
        why: "Verified machining credential holders",
      },
      {
        name: "Community-college machining programs (Ohio)",
        kind: "university",
        why: "Graduate pipelines and instructor referrals",
      },
      {
        name: "Local trade job boards",
        kind: "job_board",
        why: "Regional hourly manufacturing talent actually looks here",
      },
      {
        name: "Machining forums (Practical Machinist)",
        kind: "community",
        why: "Skilled machinists discuss shops openly",
      },
    ],
    interviewStages: [
      "Phone Screen",
      "Shop Tour + Print Reading",
      "Practical Machining Assessment",
  ...
  },
  {
    ...
    adjacentTitles: [
      "Deputy CFO at public tech co",
      "VP Finance post-IPO",
      "PE operating partner (finance)",
    ],
    domainQuestions: [
    ...
    channels: [
      {
        name: "Public-company leadership pages & filings",
        kind: "database",
        why: "Verified officer histories in comparable companies",
      },
      {
        name: "Executive networks (e.g., CFO peer groups)",
        kind: "referral",
        why: "Referral-driven at this level",
      },
      {
        name: "Board/advisor networks",
        kind: "referral",
        why: "Sitting CFOs surface through directors",
      },
      {
        name: "Conference speaker rosters (CFO summits)",
        kind: "conference",
        why: "Public-market-credible finance leaders",
      },
    ],
    interviewStages: [
      "Confidential Recruiter Conversation",
      "CEO Sessions",
      "Board Member Interviews",
      "Audit-Chair Deep-Dive",
      "References & Final",
    ],
    vocabulary: [
      "SOX",
    ...
    channels: [
      {
        name: "NMC register",
        kind: "registry",
        why: "Registration verification for UK practice",
      },
      {
        name: "NHS Jobs / trust career sites",
        kind: "job_board",
        why: "Where UK nurses actually search",
      },
      {
        name: "Critical-care nursing associations (BACCN)",
        kind: "association",
        why: "Engaged ICU-specialist population",
      },
      {
        name: "University nursing programs (London)",
        kind: "university",
        why: "Newly qualified pipeline for Band 5 development posts",
      },
    ],
    interviewStages: [
      "Screening Call",
...
const FALLBACK: MockOccupation = {
  ...
  evidenceSignals: [
    ...
    "Outcome evidence in comparable settings",
  ],
  channels: [
    { name: "LinkedIn", kind: "social", why: "Broad professional coverage" },
    {
      ...
      kind: "association",
      why: "Self-identified practitioners",
    },
  ],
