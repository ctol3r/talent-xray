...
export const DEFAULT_PIPELINE_STAGES: StageDefinition[] = [
  ...
  { key: "contact_ready", label: "Contact Ready", position: 3, isTerminal: false },
  { key: "contacted", label: "Contacted", position: 4, isTerminal: false },
  { key: "responded", label: "Responded", position: 5, isTerminal: false },
  { key: "recruiter_screen", label: "Recruiter Screen", position: 6, isTerminal: false },
  { key: "hm_review", label: "Hiring Manager Review", position: 7, isTerminal: false },
  { key: "interviewing", label: "Interviewing", position: 8, isTerminal: false },
  { key: "final", label: "Final", position: 9, isTerminal: false },
  { key: "offer_prep", label: "Offer Preparation", position: 10, isTerminal: false },
  { key: "offer_extended", label: "Offer Extended", position: 11, isTerminal: false },
  { key: "offer_accepted", label: "Offer Accepted", position: 12, isTerminal: false },
