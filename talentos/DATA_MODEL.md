...
| `search_queries`      | platform, query, purpose, breadth, expectedPrecision?, targetPhenotype?, provenance, archived, qaMeta? (`{termCount, part?, notes[]}` — normalization notes, word count and split part, Wave A), calibration? and linkedRequirementIds? (reserved for Wave B; empty until it lands). Always visible, always editable.                                                                                                                                                                                |
